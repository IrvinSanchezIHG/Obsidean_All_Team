...
`#lfc #onboarding #el-grupo #la-agencia`

> [!info] Contexto Sesión de capacitación (~2h30) sobre el proceso de **Lifecycle Campaign Execution (LFC)** para la cuenta de **El Grupo**, dentro del onboarding del equipo de Guadalajara. Participan [[Tamara]] (PM) y [[Oscar]] (developer), guiados por [[Kamaria]] e [[Laura|Laura]] (El Grupo), con sesiones a cargo de [[Anu]] (ejecución/desarrollo) y [[Kapil]] ([[La agencia]], [[Project Manager|Project Management]]).
...
- **Alpha**: autovalidación interna (developer → segundo developer → Kamaria/La agencia).
- **Beta**: revisión del cliente (El Grupo).
...
- Se documenta todo en el **Deployment Plan** (setup técnico completo en Marketing Cloud, decisiones de split, nombres de DE) — archivado en **SharePoint El Grupo** por campaña (histórico desde 2023/2024).
...
- **SharePoint (El Grupo)** → repositorio de deployment plans históricos
