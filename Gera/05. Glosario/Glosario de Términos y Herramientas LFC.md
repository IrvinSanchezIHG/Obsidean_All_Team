...
`Club` → `Silver` → `Gold` → `Platinum` → `Diamond` — niveles de estatus del programa de lealtad El Grupo One Rewards, usados constantemente como base de personalización dinámica y de elegibilidad de audiencia en las campañas LFC.
