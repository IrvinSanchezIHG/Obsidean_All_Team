...
7. Validar **formatos regionales** (fecha, numéricos) — refuerza lo ya documentado en [[LFC_20260623_GALE QA Test Case Methodology & Feedback Tracking#9. QA de otros idiomas — alcance limitado, RTL y formatos]].
...
> "The URL matrix does come from IHG itself, like the campaign team, whoever is leading the campaign."

El **Campaign Team de IHG** (quien lidere esa campaña específica) es quien entrega el contenido del URL matrix. GALE toma ese documento y construye la implementación técnica en SFMC — el detalle completo de esa DE (estructura, naming, ejemplo real `LinkMatrix_Enrolment_Booking_2026`) vive ahora en **[[Link Matrix (LinkHelper)]]**, nota nueva de esta sesión.
