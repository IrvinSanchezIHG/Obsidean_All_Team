...
# Proceso Global de Creación de Correos Electrónicos IHG 2024

> [!info]- 🔗 Enlaces entrantes
> ```dataview
> LIST
> FROM [[Proceso Global de Creación de Correos Electrónicos IHG 2024]]
> WHERE file.path != this.file.path
> ```

Nota resumen del documento de capacitación de Gale/IHG sobre el proceso de creación de correos en [[Salesforce Marketing Cloud]] (#sfmc), desde el diseño en [[Figma]] hasta el envío final.
