...
> [!abstract]- Resumen
> Plataforma SaaS de gestión de traducciones (TMS) que orquesta el flujo de localización end-to-end. IHG es cliente directo — es la herramienta detrás del [[Translation Workflow]] de LFC.
...
- **Cliente confirmado**: IHG aparece listado como cliente notable de Smartling (junto con Pinterest, Netskope y Lyft), lo que confirma que es la herramienta real detrás de las traducciones LFC, no solo una mención genérica.
